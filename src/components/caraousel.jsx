...
const data = [
    ...
    },
    {
        ...
        image: require('./Assests/IITs/img5.jpg'),
    },
    {
        id: 6,
        title: 'IIT Guwahati (IITG)',
        image: require('./Assests/IITs/img6.jpg'),
    },
    {
        id: 7,
        title: 'IIT Roorkee (IITR)',
        image: require('./Assests/IITs/img7.jpg'),
    },
    {
        id: 8,
        title: 'IIT Ropar (IITRPR)',
        image: require('./Assests/IITs/img8.jpg'),
    },
    {
        id: 9,
        title: 'IIT Bhubaneswar (IITBBS)',
        image: require('./Assests/IITs/img9.jpg'),
    },
    {
        id: 10,
        title: 'IIT Gandhinagar (IITGN)',
        image: require('./Assests/IITs/img10.jpg'),
    },
    {
        id: 11,
        title: 'IIT Hyderabad (IITH)',
        image: require('./Assests/IITs/img11.jpg'),
    },
    {
        id: 12,
        title: 'IIT Jodhpur (IITJ)',
        image: require('./Assests/IITs/img12.jpg'),
    },
    {
        id: 13,
        title: 'IIT Patna (IITP)',
        image: require('./Assests/IITs/img13.jpg'),
    },
    {
        id: 14,
        title: 'IIT Indore (IITI)',
        image: require('./Assests/IITs/img14.jpg'),
    },
    {
        id: 15,
        title: 'IIT Mandi (IITMD)',
        image: require('./Assests/IITs/img15.jpg'),
    },
    {
        id: 16,
        title: 'IIT Varanasi (IIT BHU)',
        image: require('./Assests/IITs/img16.jpg'),
    },
    {
        id: 17,
        title: 'IIT Palakkad (IITPKD)',
        image: require('./Assests/IITs/img17.jpg'),
    },
    {
        id: 18,
        title: 'IIT Tirupati (IITT)',
        image: require('./Assests/IITs/img18.jpg'),
    },
    {
        id: 19,
        title: 'IIT Dhanbad (IIT ISM)',
        image: require('./Assests/IITs/img19.jpg'),
    },
    {
        id: 20,
        title: 'IIT Bhilai (IITBH)',
        image: require('./Assests/IITs/img20.jpg'),
    },
    {
        id: 21,
        title: 'IIT Dharwad (IITDH)',
        image: require('./Assests/IITs/img21.jpg'),
    },
    {
        id: 22,
        title: 'IIT Jammu (IITJMU)',
        image: require('./Assests/IITs/img22.jpg'),
    },
    {
        id: 23,
        title: 'IIT Goa (IIT GOA)',
        image: require('./Assests/IITs/img23.jpg'),
    },
];
