  ...
  return (
    <section className='schedule-page'>
      ...
      <div className='buttons-container-2' id="style-2">
        ...
        <button className='btn-14 date-button-2' onClick={() => handleDateButtonClick('21th Dec')}>21th Dec</button>
      </div>
      ...
      <div className='schedule-div'>
        ...
        <Water_Polo matches={waterPoloMatches[selectedSport]} date={selectedDate}/>
        <Footer />
    </section>
  );
};
